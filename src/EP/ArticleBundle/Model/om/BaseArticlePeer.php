...
use EP\ArticleBundle\Model\map\ArticleTableMap;
...
abstract class BaseArticlePeer
{
    ...
    const OM_CLASS = 'EP\\ArticleBundle\\Model\\Article';

    /** the related TableMap class for this table */
    const TM_CLASS = 'EP\\ArticleBundle\\Model\\map\\ArticleTableMap';
    ...
    /** the column name for the YSource field */
    const YSOURCE = 'article.YSource';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Img', 'Header', 'Content', 'AuthorId', 'Ysource', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'img', 'header', 'content', 'authorId', 'ysource', ),
        BasePeer::TYPE_COLNAME => array (ArticlePeer::ID, ArticlePeer::TITLE, ArticlePeer::IMG, ArticlePeer::HEADER, ArticlePeer::CONTENT, ArticlePeer::AUTHOR_ID, ArticlePeer::YSOURCE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TITLE', 'IMG', 'HEADER', 'CONTENT', 'AUTHOR_ID', 'YSOURCE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'img', 'header', 'content', 'author_id', 'YSource', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Img' => 2, 'Header' => 3, 'Content' => 4, 'AuthorId' => 5, 'Ysource' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'img' => 2, 'header' => 3, 'content' => 4, 'authorId' => 5, 'ysource' => 6, ),
        BasePeer::TYPE_COLNAME => array (ArticlePeer::ID => 0, ArticlePeer::TITLE => 1, ArticlePeer::IMG => 2, ArticlePeer::HEADER => 3, ArticlePeer::CONTENT => 4, ArticlePeer::AUTHOR_ID => 5, ArticlePeer::YSOURCE => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TITLE' => 1, 'IMG' => 2, 'HEADER' => 3, 'CONTENT' => 4, 'AUTHOR_ID' => 5, 'YSOURCE' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'img' => 2, 'header' => 3, 'content' => 4, 'author_id' => 5, 'YSource' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ArticlePeer::IMG);
            $criteria->addSelectColumn(ArticlePeer::HEADER);
            $criteria->addSelectColumn(ArticlePeer::CONTENT);
            $criteria->addSelectColumn(ArticlePeer::AUTHOR_ID);
            $criteria->addSelectColumn(ArticlePeer::YSOURCE);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.YSource');
        }
    }
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ArticlePeer::AUTHOR_ID, UserPeer::ID, $join_behavior);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseArticlePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \EP\ArticleBundle\Model\map\ArticleTableMap());
      }
    }
