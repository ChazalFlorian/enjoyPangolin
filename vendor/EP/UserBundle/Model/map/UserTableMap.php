...
class UserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'vendor.EP.UserBundle.Model.map.UserTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('EP\\UserBundle\\Model\\User');
        ...
        $this->addColumn('facebookId', 'Facebookid', 'VARCHAR', false, 255, null);
        // validators
    } // initialize()
