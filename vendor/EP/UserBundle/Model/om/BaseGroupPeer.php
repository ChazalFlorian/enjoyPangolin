...
use EP\UserBundle\Model\map\GroupTableMap;
...
abstract class BaseGroupPeer
{
    ...
    const OM_CLASS = 'EP\\UserBundle\\Model\\Group';

    /** the related TableMap class for this table */
    const TM_CLASS = 'EP\\UserBundle\\Model\\map\\GroupTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseGroupPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \EP\UserBundle\Model\map\GroupTableMap());
      }
    }
